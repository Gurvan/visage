...
void main() {
  ...
  float rounding = max(v_shader_values1.w, 0.0);
  ...
  float base_distance = sdRoundedDiamond(base_position, dimensions, shader_rounding);
  float shadow_distance = sdRoundedDiamond(shadow_position, dimensions, shader_rounding);
