...
void main() {
  ...
  float base_distance = arcSignedDistance(base_position, width, thickness, center_radians, radians, 1.5);
  float shadow_distance = arcSignedDistance(shadow_position, width, thickness, center_radians, radians, 1.5);
